...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var berekendekking = function () {
    ...
    var mv1 = parseBobFormatted(
      document.getElementById("putdekselhoogte-put1").value,
    );
  ...
  var berekendekkingPut2 = function () {
    ...
    var bobberekend = parseBobFormatted(
    ...
    var mv2 = parseBobFormatted(
      document.getElementById("putdekselhoogte-put2").value,
    );
  ...
  setupBobStepper(
    "putdekselhoogte-put1",
    "putdekselhoogte-put1-up",
    "putdekselhoogte-put1-down",
  );
  setupBobStepper(
    "putdekselhoogte-put2",
    "putdekselhoogte-put2-up",
    "putdekselhoogte-put2-down",
  );
  ...
  var buildFilename = function () {
    ...
    var parts = [naam, nr1, nr2].filter(function (s) {
      return s !== "";
    });
  ...
  var collectData = function () {
    return {
      ...
      putdekselhoogte_put1: document.getElementById("putdekselhoogte-put1")
        .value,
      putdekselhoogte_put2: document.getElementById("putdekselhoogte-put2")
        .value,
  ...
  var restoreData = function (data) {
    ...
    document.getElementById("putdekselhoogte-put1").value =
      data.putdekselhoogte_put1 || "0.00";
    document.getElementById("putdekselhoogte-put2").value =
      data.putdekselhoogte_put2 || "0.00";
  ...
  document
    .getElementById("afdrukken")
    .addEventListener("click", onAfdrukkenClick);
  ...
  [
    ...
    if (el) {
      el.addEventListener("change", markBerekenStale);
    }
  });
  ...
  [
    ...
    var el = document.getElementById(id);
    if (el) {
      el.addEventListener("mousedown", markBerekenStale);
    }
  });
});
